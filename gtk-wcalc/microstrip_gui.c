...
void microstrip_gui_init(Wcalc *wcalc, GtkWidget *main_vbox,FILE *fp)
{
  ...
  wc_picture_init(wcalc, picture_vbox, (const char **) microstrip);
...
static void tooltip_init(microstrip_gui *gui)
{
  ...
  gtk_widget_set_tooltip_text( gui->text_w, "Width of microstrip" );
  gtk_widget_set_tooltip_text( gui->text_l, "Length of microstrip" );
