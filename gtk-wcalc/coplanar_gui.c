...
void coplanar_gui_init(Wcalc *wcalc, GtkWidget *main_vbox,FILE *fp)
{
  ...
  wc_picture_init(wcalc, picture_vbox, (const char **) coplanar);
...
static void values_init(coplanar_gui *gui, GtkWidget *parent)
{
  ...
  wc_button_connect(gui->button_gnd, vals_changedCB, gui);
...
static void tooltip_init(coplanar_gui *gui)
{
  ...
  gtk_widget_set_tooltip_text( gui->text_w, "Width of coplanar" );
  gtk_widget_set_tooltip_text( gui->text_s, "Spacing to ground plane" );
  gtk_widget_set_tooltip_text( gui->text_l, "Length of coplanar" );
  ...
  gtk_widget_set_tooltip_text( gui->button_gnd,
